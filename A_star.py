...
class A_star:
    ...
    def __init__(self,obstacles_point, start_point, end_point, planning_minx,planning_miny,planning_maxx,planning_maxy):
        ...
        self.start_point = (int((start_point[0]-planning_minx)/self.one),int((start_point[1]-planning_miny)/self.one))
        self.end_point = (int((end_point[0]-planning_minx)/self.one),int((end_point[1]-planning_miny)/self.one))
    ...
    def Process(self):
        ...
        best_path_X=[float(i)*self.one+self.planning_minx for i in best_path_X]
        best_path_Y=[float(i)*self.one+self.planning_miny for i in best_path_Y]
